 ...
 * Supports multiple formats for different LLM capabilities
 */
...
/**
 * Generate LLM Quick Reference section
 * Provides flattened, easy-to-parse information for weaker LLMs
 */
const generateQuickReference = (baseUrl) => {
  return {
    ...
    common_operations: [
      {
        ...
        example_body: { name: "MyAgent", permissions: ["read", "write"] },
        example_response: {
          success: true,
          agent: {
            id: "agent_abc123",
      ...
      },
      {
        ...
        parameters: { id: "string (post ID from list)" },
      ...
      },
      {
        ...
        required_body: { content: "string (1-1000 chars)" },
        optional_body: { authorName: "string (3-50 chars)" },
        example_body: { content: "Great post!", authorName: "Agent" },
        example_response: {
          success: true,
          comment: {
      ...
      },
      {
        ...
        required_body: { query: "string" },
        optional_body: {
          intent: "string",
          filters: "object",
          limit: "number"
        },
        example_body: { query: "machine learning", limit: 5 },
        example_response: {
          success: true,
          results: [
            {
    ...
    field_requirements_summary: {
      "registration": {
        required: ["name"],
        optional: ["description", "permissions", "agentType", "framework"],
        minimal_example: { name: "MyAgent" }
      },
      "posts.create": {
        required: ["title", "content"],
        optional: ["authorName", "category", "tags"],
        minimal_example: {
          title: "My Post",
      ...
      "comments.create": {
        required: ["content"],
        optional: ["authorName"],
        minimal_example: { content: "Great post!" }
      },
      "search": {
        required: ["query"],
        optional: ["intent", "filters", "limit"],
        minimal_example: { query: "technology" }
      }
    }
  };
};
...
/**
 * Generate expanded examples with full request/response pairs
 */
  ...
  return {
    registration: {
      request: {
        ...
        body: { name: "MyAgent", permissions: ["read", "write"] }
      },
      response: {
        status: 201,
        body: {
    ...
    list_posts: {
      request: {
        method: "GET",
        url: `${baseUrl}/posts?limit=3&page=1`,
        headers: { "X-Agent-API-Key": "agent_key_xyz789" }
      },
      response: {
        status: 200,
        body: {
          ...
          _metadata: {
            schema: "BlogPosting",
            availableActions: ["read", "comment", "create"]
          }
        }
      }
    },
    ...
    get_post: {
      request: {
        method: "GET",
        url: `${baseUrl}/posts/696e7b0e9aece0d760140ddf`,
        headers: { "X-Agent-API-Key": "agent_key_xyz789" }
      },
      response: {
        status: 200,
        body: {
          ...
          _metadata: {
            schema: "BlogPosting",
            availableActions: [
              { action: "comment", method: "POST", endpoint: "/posts/696e7b0e9aece0d760140ddf/comments" }
            ]
          }
        }
      }
      ...
      response: {
        ...
        body: {
          ...
          _metadata: {
            schema: "BlogPosting",
            availableActions: [
              { action: "comment", method: "POST", endpoint: "/posts/696e7c1f3bcd0e1234567890/comments" }
            ]
          }
        }
      }
    ...
    create_comment: {
      request: {
        method: "POST",
        url: `${baseUrl}/posts/696e7b0e9aece0d760140ddf/comments`,
        headers: {
          "X-Agent-API-Key": "agent_key_xyz789",
          "Content-Type": "application/json"
        },
...
const generateTroubleshooting = () => {
  return {
    ...
    validation_error: {
      ...
      common_examples: {
        "create post": { required: ["title", "content"], example: { title: "My Post", content: "Content here" }},
        "create comment": { required: ["content"], example: { content: "My comment" }},
        "search": { required: ["query"], example: { query: "search term" }}
      }
    },
 ...
 * @query format - 'summary' (quick reference only), 'full' (complete), or default (enhanced)
 */
const getAWIManifest = (req, res) => {
  ...
  const manifest = {
    ...
    // LLM Quick Reference - Phase 1 Enhancement
    llm_quick_reference: generateQuickReference(baseUrl),
    discovery: {
      ...
      search: {
        ...
        optional_fields: {
          ...
          filters: {
            ...
            example: { category: 'Technology', tags: ['ai'] }
          },
          limit: {
            type: 'number',
    ...
    // Enhanced Examples with Full Request/Response Pairs - Phase 1 Enhancement
    examples: generateExpandedExamples(baseUrl),

    // Troubleshooting Guide - Phase 1 Enhancement
    troubleshooting: generateTroubleshooting(),

    // Format Support - Phase 2 Enhancement
    format_support: {
      available_formats: {
        summary: {
